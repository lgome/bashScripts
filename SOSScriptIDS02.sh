...
for i in /opt/ShopOps_AT_MESEventPublisher_IDS_8134 /opt/ShopOps_AT_MESEventPublisher_IDS2_8135 /opt/ShopOps_AT_MESEventPublisher_IDS3_8136
do
    mkdir -p ${i}/bin/logs/jars
    unzip /tmp/jaxb_dependency.zip -d ${i}/bin/logs/jars
    echo yes | cp /tmp/wrapper.conf ${i}/conf/
done
