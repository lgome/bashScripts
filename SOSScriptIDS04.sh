...
ports=(8230 8240 8241 8245 8246 8250 8255 8270)
stations=(Admin1 Admin1 Admin1 Admin1 Admin1 Admin1 Admin1 Admin1)
eventsheets=(AT_MESCorpKafkaSimulator AT_SA_PostSnSReq AT_SA_PostSnSReq_CN AT_SA_PostSnSResp AT_SA_PostSnSResp_CN AT_CQ_OrderStop_Subscription AT_CQ_OrderStop_Release AT_CQ_OrderClose_Subscription)
...
echo 'wrapper.java.additional.10=-Dlogfile.name=../logs/CSAResponseActivity.json' >> /opt/ShopOps_AT_CSA_Response_8235/conf/wrapper.conf
echo 'wrapper.java.additional.10=-Dlogfile.name=../logs/CSAResponseActivity.log' >> /opt/ShopOps_AT_CSA_Response_8235/conf/wrapper.conf
...
# echo 'wrapper.java.classpath.5=/opt/ShopOps_AT_MESEventPublisher_IDS_8134/bin/logs/jars/jaxb_dependency/*.jar' >> /opt/ShopOps_AT_MESEventPublisher_IDS_8134/conf/wrapper.conf
# echo 'wrapper.java.classpath.5=/opt/ShopOps_AT_MESEventPublisher_IDS2_8135/bin/logs/jars/jaxb_dependency/*.jar' >> /opt/ShopOps_AT_MESEventPublisher_IDS2_8135/conf/wrapper.conf
# echo 'wrapper.java.classpath.5=/opt/ShopOps_AT_MESEventPublisher_IDS3_8136/bin/logs/jars/jaxb_dependency/*.jar' >> /opt/ShopOps_AT_MESEventPublisher_IDS3_8136/conf/wrapper.conf
...
sed -i 's/appdude/mes_corp_sub/g' /opt/ShopOp*_8230/bin/ShopOperationsServer.xml
