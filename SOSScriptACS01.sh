...
MES_CORP_HOST=${MES_CORP_HOST:-mes.prd-azr.aligntech.com}
#Create all the shopops servers
ports=(8031 8033 8034 8035 8036 8037 8038 8043 8044 8045 8275 8276)
stations=(Admin1 Admin1 Admin1 Admin1 Admin1 Admin1 Admin1 Admin1 Admin1 Admin1 Admin1 Admin1)
eventsheets=(ACS_AssetValidation ACS_TreatUpload AT_MESEventPublisher AT_ACS_Asset_Purge_Event ACS_PreMTPTreatUpload ACS_PreSTPTreatUpload AT_TPS_STPEvent ACS_AssetValidation_1 ACS_AssetValidation_2 ACS_AssetValidation_3 AT_MES_BI AT_CCSR)
...
for i in 161 162 803{0..8} 804{0..2} 8045 80{6,7,9}0 808{4..8} 812{0,5} 813{4..6} 820{0,1} 8210 822{0,1,5} 823{0,5} 824{0..9} 825{0,5} 826{0,5} 827{0,5,6} 828{0,1,5} 
do 
...
sed -i "s/admin/av/g" /opt/ShopOps*8031/bin/ShopOperationsServer.xml
sed -i "s/admin/av_1/g" /opt/ShopOps*8043/bin/ShopOperationsServer.xml
sed -i "s/admin/av_2/g" /opt/ShopOps*8044/bin/ShopOperationsServer.xml
sed -i "s/admin/av_3/g" /opt/ShopOps*8045/bin/ShopOperationsServer.xml
