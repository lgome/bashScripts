...
ports=(8032 8033 8039 8040 8041 8042 8060 8236 8237 8238)
stations=(Admin1 Admin1 Admin1 Admin1 Admin1 Admin1 Admin1 Admin1 Admin1 Admin1)
eventsheets=(ACS_AssetReplication ACS_TreatUpload ACS_AssetReplication AT_IOS_AutoSegmentationEvent ACS_PreIPLTreatUpload AT_TPS_IPLEvent AT_CQA ACS_Tagging ACS_Tagging_1 ACS_Tagging_2)
...
for i in 803{0..8} 804{0..2} 8045 80{6,7,9}0 808{4..8} 812{0,5} 813{4..6} 820{0,1} 8210 822{0,1,5} 823{0,5} 824{0..9} 825{0,5} 826{0,5} 827{0,5,6} 828{0,1,5} 161 162
do 
